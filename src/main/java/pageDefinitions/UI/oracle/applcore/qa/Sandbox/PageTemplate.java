...
public class PageTemplate {
	...
	static {
		...
		PageFactory.initElements(DriverInstance.getDriverInstance(), PageTemplate.class);
	}
	
	
	@FindBy(xpath = "//a[contains(@id , 'P_sp1:cl6')]")
	public static WebElement prefrencesLanguageEle;
	...
	public static void sourcelink(){
		WebElement sourcelink=DriverInstance.getDriverInstance().findElement(By.xpath("//td[contains(text(),'Source')]"));
