...
public class VbRedWoodRuleConfigPage extends CommonUtilsDefs  {
	
	public VbRedWoodRuleConfigPage(WebDriver driver){
		super(driver);
	...
	@FindBy(xpath ="//a[@aria-label='Actions' and @class='oj-fnd-approvals-action-icon'] | //a[@aria-label='Actions' and @class='sp-approvals-action-icon']")
	...
	@FindBy(xpath ="//div[@class='oj-fnd-approvals-step-node-title-container-readonly'] | //div[@class='sp-approvals-step-node-title-container-readonly']")
	...
	@FindBy(xpath ="//oj-option[@id='actionMenuDeleteoj-fnd-step-garph001'] | //oj-option[@id='actionMenuDeleteappr-step-graph']")
	...
	@FindBy(xpath ="//oj-button[@id='deleteStepWarningDialogOkButtonoj-fnd-step-garph001'] | //*[contains(@id,'deleteStepWarningDialogOkButtonappr-step-graph_')]")
	...
	//@FindBy(xpath ="//oj-label[contains(@id,'attribute_conditionEditor_row_r')]")
	@FindBy(xpath ="//oj-label[contains(@id,'attribute_conditionEditor_row_r')] | //input[contains(@id,'oj-searchselect-input-attribute_conditionEditor_row')] | //input[contains(@id,'oj-searchselect-input oj-text-field-input')]")
	public static WebElement attributeDropDown;
	
	@FindBy(xpath ="//input[contains(@id,'oj-searchselect-input-operator_conditionEditor_row')] | (//input[contains(@id,'operator_conditionEditor_row_r')])[1]")
...
//	@FindBy(xpath ="//div[@id='oj-listbox-drop']//div[contains(@class,'oj-listbox-search-wrapper')]//div[@class='oj-listbox-search']//input[@type='text']")
	...
	@FindBy(xpath ="//div[@id='oj-listbox-drop']/div[2]/div/div/div/input")
	...
	@FindBy(xpath ="//a[@class='appr-condition-action-close-icon']")
	//@FindBy(xpath ="//a[@class='appr-condition-action-close-icon']  | //a[@class='oj-approvals-condition-action-close-icon'] | //a[@class='appr-condition-action-trash-icon']")
	...
	@FindBy(xpath ="//div[@class='oj-switch-thumb']")
	...
	@FindBy(xpath ="//div[@id='rule-condition-editor-container_conditionEditor_authority-row-editor']//descendant::div[@class='oj-flex-bar-end']//a[contains(@title,'Close') and @class='oj-approvals-condition-action-close-icon']  | //div[@id='rule-condition-editor-container_conditionEditor_authority-row-editor']//descendant::div[@class='oj-flex-bar-end']//a[contains(@title,'Close') and @class='appr-condition-action-close-icon']")
	...
	@FindBy(xpath ="//a[@title='Close' and @class='oj-approvals-condition-action-close-icon'] | //a[@title='Close' and @class='appr-condition-action-close-icon']")
...
//	public static WebElement aagroup;
	...
	@FindBy(xpath ="//span[@class='oj-flex-item oj-approvals-rule-action-text-ghost oj-approvals-rule-ghost-text-plus'] | //span[@class='oj-flex-item appr-rule-action-text-ghost appr-rule-ghost-text-plus']")
...
//	@FindBy(xpath ="//*[@id='deploySuccessMessage']")
	...
	@FindBy(xpath ="//input[@id='startWith|input']")
...
//	@FindBy(xpath ="//oj-menu-button[@id='saveMenuButton']//button//div//span[4]")
	...
	public void launchURL(WebDriver driver) {
		try {
			driver.get(RestCommonUtils.getExecutableHost()+"fscmUI/approvals/vp/approvalsconfiguration");
			CommonUtils.waitForPageLoad(driver);
		} catch (Exception e) {
	 ...
	 public void logout(WebDriver driver) {
			...
			try {
				driver.get(RestCommonUtils.getExecutableHost()+"fscmUI/faces/FuseWelcome");
					CommonUtils.hold(5);
