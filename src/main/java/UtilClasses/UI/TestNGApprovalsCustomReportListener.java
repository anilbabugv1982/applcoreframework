...
public class TestNGApprovalsCustomReportListener extends GetDriverInstance implements IReporter {
 ...
 // ~ Methods --------------------------------------------------------------
    ...
    public void generateLabelSummaryReport(List<ISuite> suites) throws Exception {
		...
		CommonUtils.hold(15);
         ...
         //tableColumnStart("ATGPF Patch");
         out.print("<th align= \"left\">ATGPF PATCH </th>");
         out.print("<td>" + ATG_Patch + "</td>");
         out.print("</tr>");
         //tableColumnStart("Test Case Doc");
         out.print("<th align= \"left\">Test Case Doc </th>");
         out.print("<td>" + "<a href='https://confluence.oraclecorp.com/confluence/pages/viewpage.action?spaceKey=FMWTOOL&title=Invoices+Use+cases+for+Approval+FARE'>" + "TestCases</a>" + "</td>");
         CommonUtils.hold(10);
    ...
    /*    out.println(".passedodd td {background-color: #0A0}");
      ...
      /*  out.println(".passedodd td,.numi_attn {background-color: #0A0}");
        out.println(".passedeven td,.stripe {background-color: #3F3}");
