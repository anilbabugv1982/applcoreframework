...
public class TestNGCustomReportListener extends GetDriverInstance implements IReporter {
 ...
 // ~ Methods --------------------------------------------------------------
    ...
    public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites,
        ...
        startHtml(out);
        try {
			generateLabelSummaryReport(suites);
		} catch (Exception e) {
    ...
    public void generateLabelSummaryReport(List<ISuite> suites) throws Exception {
    	
    	System.setProperty("webdriver.gecko.driver", "./src/test/resources/geckodriver.exe");
    	labelDriverInstance = getDriverInstanceObject();
    	//WebDriver d1=new FirefoxDriver();
    	labelDriverInstance.get(GetDriverInstance.EnvironmentName);
    	labelDriverInstance.manage().window().maximize();
    	CommonUtils.hold(4);
    	labelDriverInstance.findElement(By.id("userid")).sendKeys("app_impl_consultant");
    	labelDriverInstance.findElement(By.id("password")).sendKeys("Welcome1");
    	labelDriverInstance.findElement(By.id("btnActive")).click();
    	CommonUtils.hold(10);
    	labelDriverInstance.findElement(By.xpath("//*[contains(@id,'UIScmil1u::icon')]")).click();
    	CommonUtils.hold(15);
		
    	labelDriverInstance.findElement(By.xpath("//a[@id='pt1:_UIScmi99']")).click();
		CommonUtils.hold(15);
		
    	 tableStart("testOverview", null);
         out.print("<tr>");
         String ADF_Patch=labelDriverInstance.findElement(By.xpath("//span[@id='pt1:_UISatpr4:0:i1:0:ott22']")).getText();
         String ATG_Patch=labelDriverInstance.findElement(By.xpath("//span[@id='pt1:_UISatpr4:0:i1:1:ott22']")).getText();
         String DB_Patch=labelDriverInstance.findElement(By.xpath("//span[@id='pt1:_UISatpr4:0:i1:1:ott23']")).getText();
         String BrowserType=System.getProperty("ExecutableBrowser");
         CommonUtils.hold(10);
         labelDriverInstance.findElement(By.id("pt1:_dialog::close")).click();
         //tableColumnStart("ADF Patch");
         out.print("<th align= \"left\">ADF PATCH </th>");
         out.print("<td>" + ADF_Patch + "</td>");
         out.print("</tr>");
         //tableColumnStart("ATG Patch");
         out.print("<th align= \"left\">ATGPF PATCH </th>");
         out.print("<td>" + ATG_Patch + "</td>");
         out.print("</tr>");
         //tableColumnStart("DB Patch");
         out.print("<th align= \"left\">DB PATCH </th>");
         out.print("<td>" + DB_Patch + "</td>");
         out.print("</tr>");
         Log.info("Browser Type");
         out.print("<th align= \"left\">BROWSER TYPE </th>");
         out.print("<td>" + BrowserType + "</td>");
         out.print("</tr>");
         
         //tableColumnStart("FA Impact Wiki");	
         out.print("<th align= \"left\">FA Impact Wiki </th>");
         out.print("<td>" + "<a href='http://aseng-wiki.us.oracle.com/asengwiki/display/TechArch/Impact+to+FA+Automated+Tests'>" + "ImpactWiki</a>" + "</td>");
         CommonUtils.hold(10);
         labelDriverInstance.quit();
         if(!("local".equalsIgnoreCase(executionPlatform))){
             CommonUtils.hold(900);
         }
         else{
             System.out.println("Execution platform is local hence not pausing the execution");
         }
